...
$(selector).calendarsPicker({minDate: 0, maxDate: '+1m +1w'}) */
    $.JQPlugin.createPlugin({
        ...
        defaultRenderer: {
            ...
            dayHeader: '<th>{day}</th>',
            week: '<tr>{days}</tr>',
            day: '<td class="idatepicker-cell-day">{day}</td>',
  ...
  maxDate: $.calendars.newDate(2010, 12, 31)}) */
        ...
        regionalOptions: { // Available regional settings, indexed by language/country code
            '': { // Default regional settings - English/US
                ...
                prevText: '<svg><path d="M 17,12 l -5,5 l 5,5"></path></svg>',
                prevStatus: 'Show the previous month',
                prevJumpText: '&lt;&lt;',
                prevJumpStatus: 'Show the previous year',
                nextText: '<svg><path d="M 14,12 l 5,5 l -5,5"></path></svg>',
        ...
        _update: function(elem, hidden) {
            ...
            if (!$.isEmptyObject(inst)) {
                ...
                if (inst.inline) {
                    ...
                    if (!inst.div) {
                        inst.div = $('<div><i class="datepicker--pointer"></i></div>').addClass(this._popupClass).
                        css({

...
def get_columns(filters, salary_slips):
	...
	res_components = ["Company Pension Insurance", "Employee Pension Insurance", "Employee Risk", "Risk On Company"]
	insurance_type = filters.get("insurance_type", False)
	if insurance_type == "Saudi":
		res_components = ["Company Pension Insurance", "Employee Pension Insurance"]
	elif insurance_type == "Non Saudi":
		res_components = ["Risk On Employee", "Risk On Company"]
	...
	for component in frappe.db.sql(
		...
		if component.salary_component in res_components:
